...
function writeIntro() {
    ...
    fill(255)
    text('This interactive website contains the last words said by people before their plane crashed.', 0, -windowHeight/16, 350)
    text('Hover over the dots to know more.', 0, windowHeight/10, 350)
